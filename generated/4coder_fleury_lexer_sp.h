...
TokenSpKind_stock = 127,
TokenSpKind_LiteralTrue = 128,
TokenSpKind_LiteralFalse = 129,
TokenSpKind_Identifier = 130,
TokenSpKind_PPInclude = 131,
TokenSpKind_PPVersion = 132,
TokenSpKind_PPDefine = 133,
TokenSpKind_PPUndef = 134,
TokenSpKind_PPIf = 135,
TokenSpKind_PPIfDef = 136,
TokenSpKind_PPIfNDef = 137,
TokenSpKind_PPElse = 138,
TokenSpKind_PPElIf = 139,
TokenSpKind_PPEndIf = 140,
TokenSpKind_PPError = 141,
TokenSpKind_PPImport = 142,
TokenSpKind_PPUsing = 143,
TokenSpKind_PPLine = 144,
TokenSpKind_PPPragma = 145,
TokenSpKind_PPUnknown = 146,
TokenSpKind_PPDefined = 147,
TokenSpKind_COUNT = 148,
};
