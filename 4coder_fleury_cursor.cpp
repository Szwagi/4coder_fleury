...
F4_HighlightCursorMarkRange(Application_Links *app, View_ID view_id)
{
    ...
    draw_rectangle(app, Rf32(view_rect.x0, lower_bound_y, view_rect.x0 + 2, upper_bound_y), 1.f,
                   fcolor_resolve(fcolor_change_alpha(fcolor_id(defcolor_comment), 0.15f)));
    draw_set_clip(app, clip);
}
